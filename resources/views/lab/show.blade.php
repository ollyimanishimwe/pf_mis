                              ...
                              <div class="card-body">
                                  ...
                                  <form method="POST" action="{{ action('LabController@store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                              ...
                                              <label for="dob" class="control-label mb-1">Date Of Birth</label>
                                                <div class="input-group">
                                                    <input id="" name="" type="text" class="is-valid form-control-success form-control" value="{{$patient->dob}}" data-val="true" data-val-required="Please enter the Date Of Birth"  readonly="" >
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-6">
                                          <div class="form-group">
                                            <label for="examination_results" class="control-label mb-1">Examination Results</label>

                                               <textarea name="examination_results" id="examination_results"  rows="3" placeholder="Examination Results..." class="is-valid form-control-success form-control" ></textarea>
                                          </div>
                                        </div>
