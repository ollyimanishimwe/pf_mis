                        ...
                        <div class="card-body">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  ...
                                  <hr>
                                  <form method="POST" action="{{ action('PatientController@store') }}" enctype="multipart/form-data">
                                        @csrf
                                          ...
                                          <div class="col-3">
                                              <div class="form-group">
                                                  ...
                                                  <select name="province" id="province" required class="form-control-sm form-control">
					                                ...
					                                <option value="" disabled>south</option>
					                                <option value="" disabled>kigali city</option>
					                              </select>
                                          ...
                                          <div class="col-3">
                                              <div class="form-group">
                                                  ...
                                                  <select name="sector" required id="sector" class="form-control-sm form-control">
                                                    ...
                                                    <option value="4">Gataraga</option>

                                                    <option value="" disabled>====Gicumbi====</option>
                                                    ...
                                                    <option value="" disabled>====Rulindo====</option>
					                                ...
					                                <option value="" disabled>====Gakenke====</option>
					                                ...
					                                <option value="" disabled>====Burera====</option>
