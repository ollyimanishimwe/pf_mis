                    ...
                    <div class="col-md-12">
                        <section class="card">
                            <div class="twt-feed blue-bg">
                                ...
                                <div class="media">
                                    <a href="#">
                                        <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="{{'../images/'.$patient->patient_image}}">
                                    </a>
                                    <div class="media-body">
                                    <h2 class="text-white display-6">{{$patient->names}}</h2>
                                        <p class="text-light">Patient</p>
                                    </div>
                                </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                        <a href="#"> <i class="fa fa-users"></i> FAMILLY CHIEF / {{$patient->family_chief}}
                                </li>

	                            <li class="list-group-item">
	                                <a href="#"> <i class="fa fa-tasks"></i> FROM / {{$patient->province}} / {{$patient->district}} / {{$patient->sector}}/ {{$patient->cell}} / {{$patient->village}}
	                            </li>

	                            <li class="list-group-item">
	                                <a href="#"> <i class="fa fa-h-square" style="color: red"></i> INSURANCE / {{$patient->insurance_company}}
	                            </li>
	                            <li class="list-group-item">
	                                <a href="#"> <i class="fa fa-tasks"></i> INSURANCE No / {{$patient->insurance_id}}
	                            </li>
